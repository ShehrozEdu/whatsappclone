...
export default function LoginPage() {
  return (
    <div className="theme-green login-page-main py-5">
      <div className="logo-margin mb-3 d-flex align-items-center">
        <svg
        ...
        <span className="text-white fw-bold text-uppercase ms-3">
          Whatsapp web
        </span>
      </div>
